...
export async function GET() {
  ...
  const projects =  [
    {
      ...
      "CONNEKT is a comprehensive web-based solution designed to simplify the management of virtual work assistance tasks and services. Built with a modern, intuitive user interface, the platform enables businesses and professionals to seamlessly assign, track, and manage tasks in real-time, fostering greater efficiency in handling remote assistance operations.",
        // "CONNEKT offers a range of precision-engineered digital services designed to streamline organization's and businesses' operations, enhance their digital footprint, and drive growth.",
      technologies: [
        "Next.js",
        "MySQL",
        "Sass",
    ...
    },
    {
      ...
      active: true,
      description:
        "The GitHub Viewer web app provides developers and recruiters with an intuitive interface for accessing comprehensive GitHub profile information. It offers visually appealing displays of essential details, including profile images, work positions, and public repository statistics.  ",
      technologies: [
        "React",
        "Sass",
        "GitHub API",
  ...
  return NextResponse.json(projects);  // Send a JSON response with the users
}
...
// Optionally, you can handle other HTTP methods (PUT, DELETE)